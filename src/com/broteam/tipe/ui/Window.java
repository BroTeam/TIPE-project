...
public class Window extends JFrame implements ModelListener {
...

	{
		...
		actionStopSimulation.putValue(AbstractAction.SHORT_DESCRIPTION, text);
	}
	...
	private void initSimulationPanel() {
		...
		comboBoxAp.addActionListener((e) -> {
			if (model != null) {
				AccessPoint selected = getSelectedAccessPoint();
				for (AccessPoint ap : model.getAccessPoints()) {
